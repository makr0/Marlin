...
#define STRING_CONFIG_H_AUTHOR "(mdt, skr1.4 from Marlin)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ALU Schrotti"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 61.81
  #define DEFAULT_bedKi 11
  #define DEFAULT_bedKd 230
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 400, 400, 1600, 400 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 100, 300 }
...
#define MANUAL_PROBE_START_Z 0.3
...
#define NEOPIXEL_LED
 ...
 // already defined in pins_BTT_SKR_V1_4.H #define NEOPIXEL_PIN     4       // LED driving pin
  //#define NEOPIXEL2_TYPE NEOPIXEL_TYPE
  //#define NEOPIXEL2_PIN    5
  #define NEOPIXEL_PIXELS 72       // Number of LEDs in the strip, larger of 2 strips if 2 neopixel strips are used
  #define NEOPIXEL_IS_SEQUENTIAL   // Sequential display for temperature change - LED by LED. Disable to change all LEDs at once.
  #define NEOPIXEL_BRIGHTNESS 127  // Initial brightness (0-255)
  #define NEOPIXEL_MAX_BRIGHTNESS 150  // no rgb component can be bigger than this value
                                      // use this to liit current throug your LEDs in case your power supply cant keep up
